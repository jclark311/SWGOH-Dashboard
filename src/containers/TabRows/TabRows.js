...
const TabRows = ({name, description, success, message, metrics = null}) => (
	<Row>
		<Col xs={12} style={{position: 'sticky', position: '-webkit-sticky', position: '-moz-sticky', position: '-ms-sticky', position: '-o-sticky', top:'25px', zIndex: '2'}}>
			<h3>LEGENDARY CHARACTERS</h3>
			<p>Requirements - 7 Star - Gear 12 - Level 85</p>
		</Col>

		<Col md={6} className="tablestart notmainteam">
